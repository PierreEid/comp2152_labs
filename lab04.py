...
monster_power = random.choice(list(monster_powers.keys())) # ["Fire Magic", "Freeze Time", "Super Hearing"])
# print(monster_power)

# Q3: Update Monster's Combat Strength
m_combat_strength = min(6, m_combat_strength + monster_powers[monster_power])
print(f"Monster rolled {monster_power}, increasing their combat strength to: {m_combat_strength}")
...
loot_item1_i = random.choice(list(range(0, 5)))
loot_item1 = loot_options.pop(loot_item1_i)
...
loot_item2_i = random.choice(list(range(0, 4)))
loot_item2 = loot_options.pop(loot_item2_i)
